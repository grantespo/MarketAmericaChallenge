...
jest.mock('../components/products/ProductCard', () => {
  ...
  const ProductCard = jest.fn(({ product }) => (
...
describe('ProductListScreen', () => {
  ...
  it('loads more products and shows loading indicator', async () => {
    ...
    (searchProducts as jest.Mock).mockResolvedValueOnce({ products: initialProducts });
  
    // Mock loadMore call (delay resolution)
    (searchProducts as jest.Mock).mockImplementationOnce(() => new Promise(resolve => {
