...
import { skuWithImageInStock, skuWithoutImageOutOfStock } from "../__mocks__/MockSku";
...
describe("SkuCard Component", () => {
  ...
  it("renders correctly with image and IN_STOCK", () => {
    const { getByText, getByTestId } = render(<SkuCard sku={skuWithImageInStock} />);
  ...
  it("renders correctly without image and OUT_OF_STOCK", () => {
    const { getByText, queryByTestId } = render(<SkuCard sku={skuWithoutImageOutOfStock} />);
